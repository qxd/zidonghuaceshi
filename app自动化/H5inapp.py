...
#打开消息
# massege_entrance = driver.find_element_by_id('com.ifeixiu.flysender.debug:id/iv_right1')
massege_entrance = driver.find_elements_by_class_name('android.widget.ImageView')[0]

print(massege_entrance)

massege_entrance.click()

driver.find_elements_by_class_name('android.widget.RelativeLayout')[2].click()
print(driver.find_elements_by_class_name('android.widget.RelativeLayout')[2])

driver.find_elements_by_class_name('android.view.ViewGroup')[0].click()
print(driver.find_elements_by_class_name('android.view.ViewGroup')[0])
